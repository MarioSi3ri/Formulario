            ...
            <div>
                <table class="tarjeta">
                    <thead>
                        ...
                        <th><a href="https://uveg.edu.mx/index.php/es/info-isc" target="_blank">
                    ...
                    <tbody>
                        ...
                        <form name="Registro" method="post" action="index.php">
                            ...
                            <td><p>"Aceptaci&oacute;n del <a href="https://uveg.edu.mx/modules/mod_preregistro/resources/images/aviso_integrado.pdf" target="_blank" title="Presione para leer el aviso de privacidad">Aviso de Privacidad</a>"</p></td>
                        </form>
                        </tr>
                    </tbody>
                </table>
