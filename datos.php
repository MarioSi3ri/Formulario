...
<html lang="es">
    <head>
        ...
        <button id="toggleTheme" title="Cambia el tema de la p&aacute;gina"><span class="material-symbols-outlined">nights_stay</span></button>
           ...
           <div>
            <h2>✏️Actualizar sus datos</h2>
            </div>
           <div>
                <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                <label for="nombre">Nombre: </label><span class="verif"></span>
                <input class="input" name="nombre" id="nombre" placeholder="Ingresa tu nombre" title="Por favor, escribe tu nombre completo" value="<?php echo htmlspecialchars($nombre); ?>" required autofocus>
